...
type
    ...
    LoadingDone* = object
        ## Emitted when all the loading tasks are complete
...
template execTask*(control: Bundle[LoadTasks], label: string, kind: typedesc, key: Ordinal, body: untyped) =
