...
type
    CrankMode* = enum CrankRequired, CrankNotRequired
...
proc buildCrankAlerter*[Assets; SheetId: enum, Active: enum](
    ...
    return proc (
        ...
        return proc() =
            let shouldShow =
                required == CrankRequired and
                playdate.system.isCrankDocked() and
                activeState.isSome and
                activeState.get in activeStates
