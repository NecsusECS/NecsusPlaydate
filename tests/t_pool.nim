...
proc checkValue(pair: Pooled[PooledVal], name: string, id: int, counts: int): Pooled[PooledVal] =
...
proc checkValue(pair: Pooled[PooledVal], name: string, key: PoolKey, id: int, counts: int): Pooled[PooledVal] =
